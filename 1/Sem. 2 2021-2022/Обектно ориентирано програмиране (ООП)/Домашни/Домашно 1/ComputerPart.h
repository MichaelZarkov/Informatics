...
private:
	...
	static const char PART_TYPE_NAMES[][11];
...
public:
	...
	~ComputerPart();
	bool operator==(const ComputerPart&) const;

private:

	ComputerPart& operator=(const ComputerPart&);	// For obj initialization use 'setComputerPartOnce()' instead.
