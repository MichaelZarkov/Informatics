...
// Helper functions
// these are accessible only here (in this translation unit, internal linkage)
...
void printStudent(const Student& student)
{
	...
	cout << "Address: " << endl;
	// the address is an instance of the structure Address
	// it cannot be displayed simply using the operator <<
